...
export type CartRecommendationMoneyFragment = Pick<
  StorefrontAPI.MoneyV2,
  'amount' | 'currencyCode'
>;

export type CartRecommendationProductFragment = Pick<
  StorefrontAPI.Product,
...
export type ProductItemFragment = Pick<
  ...
  'id' | 'handle' | 'title' | 'availableForSale'
> & {
  audience?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  featuredImage?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Image, 'id' | 'altText' | 'url' | 'width' | 'height'>
  >;
  images: {
      ...
      Pick<StorefrontAPI.Filter, 'id' | 'label' | 'type'> & {
        values: Array<
          Pick<
            ...
            'id' | 'label' | 'count' | 'input'
          > & {
            swatch?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Swatch, 'color'>>;
          }
        >;
      }
    >;
...
export type ProductMoneyFragment = Pick<
  StorefrontAPI.MoneyV2,
  'amount' | 'currencyCode'
>;

export type ProductImageDataFragment = Pick<
  StorefrontAPI.Image,
  'id' | 'url' | 'altText' | 'width' | 'height'
>;
...
> & {
  audience?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  disclosures?: StorefrontAPI.Maybe<{
      ...
      nodes: Array<
        ...
        | ({__typename: 'Metaobject'} & Pick<StorefrontAPI.Metaobject, 'id'> & {
              ...
              content?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.MetaobjectField, 'type' | 'value'>
              >;
              displayPreferences?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.MetaobjectField, 'value'>
              >;
              symbol?: StorefrontAPI.Maybe<{
...
export type ProductRecommendationCardFragment = Pick<
  StorefrontAPI.Product,
...
export type AudienceLandingQueryVariables = StorefrontAPI.Exact<{
  audienceHandle: StorefrontAPI.Scalars['String']['input'];
  collectionOneHandle: StorefrontAPI.Scalars['String']['input'];
  collectionTwoHandle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  featuredHandle: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type AudienceLandingQuery = {
  ...
  audienceCollection?: StorefrontAPI.Maybe<{
    products: {
      nodes: Array<
        Pick<
          StorefrontAPI.Product,
...
export type AudienceProductCardFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'title' | 'handle' | 'availableForSale'
> & {
  audience?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
...
export type AudienceCollectionCardFragment = Pick<
  StorefrontAPI.Collection,
  'id' | 'title' | 'handle'
> & {
  image?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query AudienceLanding(\n    $audienceHandle: String!\n    $collectionOneHandle: String!\n    $collectionTwoHandle: String!\n    $country: CountryCode\n    $featuredHandle: String!\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    featuredCollection: collection(handle: $featuredHandle) {\n      products(first: 4) {\n        nodes {\n          ...AudienceProductCard\n        }\n      }\n    }\n    audienceCollection: collection(handle: $audienceHandle) {\n      products(first: 12) {\n        nodes {\n          ...AudienceProductCard\n        }\n      }\n    }\n    collectionOne: collection(handle: $collectionOneHandle) {\n      ...AudienceCollectionCard\n    }\n    collectionTwo: collection(handle: $collectionTwoHandle) {\n      ...AudienceCollectionCard\n    }\n    fallbackProducts: products(first: 12, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...AudienceProductCard\n      }\n    }\n  }\n\n  fragment AudienceProductCard on Product {\n    id\n    title\n    handle\n    availableForSale\n    audience: metafield(namespace: "custom", key: "audience") {\n      value\n    }\n    featuredImage {\n      id\n      url\n      altText\n      width\n      height\n    }\n    images(first: 5) {\n      nodes {\n        id\n        url\n        altText\n        width\n        height\n      }\n    }\n    options {\n      name\n      optionValues {\n        name\n      }\n    }\n    selectedOrFirstAvailableVariant {\n      id\n      availableForSale\n      title\n      price {\n        amount\n        currencyCode\n      }\n      compareAtPrice {\n        amount\n        currencyCode\n      }\n      selectedOptions {\n        name\n        value\n      }\n      image {\n        id\n        url\n        altText\n        width\n        height\n      }\n      product {\n        handle\n        title\n      }\n      quantityRule {\n        increment\n        maximum\n        minimum\n      }\n    }\n    variants(first: 100) {\n      nodes {\n        id\n        availableForSale\n        title\n        price {\n          amount\n          currencyCode\n        }\n        compareAtPrice {\n          amount\n          currencyCode\n        }\n        selectedOptions {\n          name\n          value\n        }\n        image {\n          id\n          url\n          altText\n          width\n          height\n        }\n        product {\n          handle\n          title\n        }\n        quantityRule {\n          increment\n          maximum\n          minimum\n        }\n      }\n      pageInfo {\n        hasNextPage\n      }\n    }\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n  }\n\n  fragment AudienceCollectionCard on Collection {\n    id\n    title\n    handle\n    image {\n      id\n      url\n      altText\n      width\n      height\n    }\n  }\n': {
    return: AudienceLandingQuery;
    variables: AudienceLandingQueryVariables;
  };
}
